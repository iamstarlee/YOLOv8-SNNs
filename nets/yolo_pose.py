...
from nets.backbone import Backbone, C2f, Conv, DFL
from nets.yolo_training import weights_init
from utils.utils_bbox import make_anchors
from utils.utils import dist2bbox
import math
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=(128, 256, 512)):  # detection layer
        super().__init__()
...
class Pose(Detect):
    ...
    lynxi_compile = False
    def __init__(self, nc=80, kpt_shape=(17, 3), ch=(128, 256, 512)):
